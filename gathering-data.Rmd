...
library(rstanarm)
require("knitr")
# opts_knit$set(root.dir = "~/Desktop/GOV_50/home-field-advantage")
```
...
nba_names_2004 <- read_csv("raw_data/nbascores2004-feb2020/teams.csv") %>%
  clean_names()
...
nba_scores_2004 <- read_csv("raw_data/nbascores2004-feb2020/games.csv") %>%
  clean_names() %>%
  rename(team_id = home_team_id) %>%
  select(team_id, season, pts_home, pts_away)
